 ...
 */
namespace App\bbb\src;

use App\bbb\src\Core\ApiMethod;
use App\bbb\src\Parameters\CreateMeetingParameters;
use App\bbb\src\Parameters\DeleteRecordingsParameters;
use App\bbb\src\Parameters\EndMeetingParameters;
use App\bbb\src\Parameters\GetMeetingInfoParameters;
use App\bbb\src\Parameters\GetRecordingsParameters;
use App\bbb\src\Parameters\HooksCreateParameters;
use App\bbb\src\Parameters\HooksDestroyParameters;
use App\bbb\src\Parameters\IsMeetingRunningParameters;
use App\bbb\src\Parameters\JoinMeetingParameters;
use App\bbb\src\Parameters\PublishRecordingsParameters;
use App\bbb\src\Parameters\UpdateRecordingsParameters;
use App\bbb\src\Responses\ApiVersionResponse;
use App\bbb\src\Responses\CreateMeetingResponse;
use App\bbb\src\Responses\DeleteRecordingsResponse;
use App\bbb\src\Responses\EndMeetingResponse;
use App\bbb\src\Responses\GetDefaultConfigXMLResponse;
use App\bbb\src\Responses\GetMeetingInfoResponse;
use App\bbb\src\Responses\GetMeetingsResponse;
use App\bbb\src\Responses\GetRecordingsResponse;
use App\bbb\src\Responses\HooksCreateResponse;
use App\bbb\src\Responses\HooksDestroyResponse;
use App\bbb\src\Responses\HooksListResponse;
use App\bbb\src\Responses\IsMeetingRunningResponse;
use App\bbb\src\Responses\JoinMeetingResponse;
use App\bbb\src\Responses\PublishRecordingsResponse;
use App\bbb\src\Responses\SetConfigXMLResponse;
use App\bbb\src\Responses\UpdateRecordingsResponse;
use App\bbb\src\Util\UrlBuilder;
